...
Module['FS_createPath']('/tmp', 'examples', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 144, "filename": "/tmp/examples/test_fib.js"}, {"start": 144, "audio": 0, "end": 2061, "filename": "/tmp/examples/pi.js"}, {"start": 2061, "audio": 0, "end": 2089, "filename": "/tmp/examples/hello.js"}, {"start": 2089, "audio": 0, "end": 6906, "filename": "/tmp/examples/point.c"}, {"start": 6906, "audio": 0, "end": 7036, "filename": "/tmp/examples/hello_module.js"}, {"start": 7036, "audio": 0, "end": 7754, "filename": "/tmp/examples/test_point.js"}, {"start": 7754, "audio": 0, "end": 7920, "filename": "/tmp/examples/fib_module.js"}, {"start": 7920, "audio": 0, "end": 10211, "filename": "/tmp/examples/fib.c"}], "remote_package_size": 10211, "package_uuid": "2fc58f01-d8e8-48a6-8d73-8b74053830a7"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 130992,
    DYNAMIC_BASE = 5373872,
    DYNAMICTOP_PTR = 130832;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 130896, 4), 130896);
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__clock_gettime": ___clock_gettime, "__lock": ___lock, "__syscall10": ___syscall10, "__syscall114": ___syscall114, "__syscall12": ___syscall12, "__syscall142": ___syscall142, "__syscall183": ___syscall183, "__syscall195": ___syscall195, "__syscall196": ___syscall196, "__syscall197": ___syscall197, "__syscall220": ___syscall220, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall38": ___syscall38, "__syscall39": ___syscall39, "__syscall4": ___syscall4, "__syscall40": ___syscall40, "__syscall41": ___syscall41, "__syscall42": ___syscall42, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall63": ___syscall63, "__syscall83": ___syscall83, "__syscall85": ___syscall85, "__unlock": ___unlock, "_exit": __exit, "abort": _abort, "atexit": _atexit, "clock": _clock, "dlclose": _dlclose, "dlopen": _dlopen, "dlsym": _dlsym, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "execv": _execv, "execvp": _execvp, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "fork": _fork, "gettimeofday": _gettimeofday, "kill": _kill, "localtime_r": _localtime_r, "memory": wasmMemory, "nanosleep": _nanosleep, "popen": _popen, "round": _round, "setTempRet0": _setTempRet0, "signal": _signal, "sysconf": _sysconf, "table": wasmTable, "utimes": _utimes, "waitpid": _waitpid };
var asm = createWasm();
...
var real_dynCall_jijjii = asm["dynCall_jijjii"];
asm["dynCall_jijjii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijjii.apply(null, arguments);
};

var real_dynCall_jijiiiii = asm["dynCall_jijiiiii"];
asm["dynCall_jijiiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijiiiii.apply(null, arguments);
};
...
var real_dynCall_jijiii = asm["dynCall_jijiii"];
asm["dynCall_jijiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijiii.apply(null, arguments);
};

var real_dynCall_jijiiii = asm["dynCall_jijiiii"];
asm["dynCall_jijiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijiiii.apply(null, arguments);
};
...
var real_dynCall_iijijjji = asm["dynCall_iijijjji"];
asm["dynCall_iijijjji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iijijjji.apply(null, arguments);
};
...
var real_dynCall_jijij = asm["dynCall_jijij"];
asm["dynCall_jijij"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijij.apply(null, arguments);
};

var real_dynCall_iijijji = asm["dynCall_iijijji"];
asm["dynCall_iijijji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iijijji.apply(null, arguments);
};

var real_dynCall_jijji = asm["dynCall_jijji"];
asm["dynCall_jijji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_jijji.apply(null, arguments);
};
...
var dynCall_jijiiiii = Module["dynCall_jijiiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_jijiiiii"].apply(null, arguments)
};
...
var dynCall_jijiiii = Module["dynCall_jijiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_jijiiii"].apply(null, arguments)
};
...
var dynCall_iijijjji = Module["dynCall_iijijjji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iijijjji"].apply(null, arguments)
};
...
var dynCall_jijij = Module["dynCall_jijij"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_jijij"].apply(null, arguments)
};

var dynCall_iijijji = Module["dynCall_iijijji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iijijji"].apply(null, arguments)
};
